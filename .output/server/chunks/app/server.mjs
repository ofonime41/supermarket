...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a3ba5f5f.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/test-d4ad7991.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-e15126db.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-51421357.mjs').then((r) => r.default || r));

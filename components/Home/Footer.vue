...
<footer class="relative z-10 bg-[#0e5aa7] text-white   pb-10  lg:pb-20">
	<div class="bg-[#0a437c] py-4 text-center text-xl"> <a href="#">Go back to Top</a>  </div>
  <div class="container mx-auto px-4 lg:px-20 ">
    <div class="container mx-auto flex justify-between mt-8 flex-wrap">
      <div class="w-full px-4 my-4 sm:w-2/3 lg:w-3/12">
        <div class="mb-10 w-full">
          <a href="#" class="mb-6 inline-block max-w-[160px]">
            ...
            /> -->
                    ...
                    <span class="self-center ml-2 sm:ml-0 text-2xl font-semibold whitespace-nowrap dark:text-white">Supermaket</span>
        ...
        <div class="mb-10 w-full">
          ...
          <ul>
            <li>
              <a
                href=""
                class="text-body-color hover:text-primary  inline-block text-base leading-loose"
              >
			  Customer service
              </a>
            </li>
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">Shipping & Delivery</h4>
          <ul>
            <li>
              <a
                href=""
            ...
            <li>
              <a
                ...
                class="text-body-color hover:text-primary  inline-block text-base leading-loose"
              >
			  About Majid Al Futtaim Carrefour & Society
              </a>
            </li>
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">Help & Support</h4>
